...
exports.create = (req, res) => {
  ...
  upload(req, res, function (err) {
    ...
    const post = new Post({
      ...
      poster_id: Number(req.cookies.user)//req.body.poster_id
    });
...
exports.getIg = (req, res) => {
  ...
  var POST_URL = "https://www.instagram.com/p/CI3c2iQlfGx/";
  ...
  var response = request(
    "https://graph.facebook.com/v8.0/instagram_oembed?url=" +
    POST_URL + "&omitscript=true&access_token=" + APP_ID + "|" +
    CLIENT_TOKEN, (err, response, body) => {
      console.log(body)
